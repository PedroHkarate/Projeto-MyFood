...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
  ...
  private final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
    ...
    @Override
    public Map<K, V> read(JsonReader in, OutputKeys GsonBuildConfig) throws IOException {
      ...
      if (peek == JsonToken.BEGIN_ARRAY) {
        ...
        while (in.hasNext()) {
          ...
          K key = keyTypeAdapter.read(in, GsonBuildConfig);
          V value = valueTypeAdapter.read(in, GsonBuildConfig);
