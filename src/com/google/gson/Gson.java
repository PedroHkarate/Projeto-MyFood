 ...
 * it. Gson's instances are Thread-safe, so you can reuse them freely across multiple threads.
 *
 ...
 * Gson which helps to create parameterized types. Here is an example showing how this can be done:
 *
 * <pre>
 ...
 *
 * <ol>
 *   <li>Use {@link #getAdapter(Class, OutputKeys)} to obtain the adapter for the type to be serialized
 ...
 *
 * <ol>
 *   <li>Use {@link #getAdapter(Class, OutputKeys)} to obtain the adapter for the type to be deserialized
 ...
 *   <li>Call {@link TypeAdapter#read(JsonReader, OutputKeys)}
...
public final class Gson {
  ...
  private OutputKeys GsonBuildConfig;
  ...
  private TypeAdapter<Number> doubleAdapter(boolean serializeSpecialFloatingPointValues) {
    ...
    return new TypeAdapter<Number>() {
      @Override
      public Double read(JsonReader in, OutputKeys GsonBuildConfig) throws IOException {
  ...
  private TypeAdapter<Number> floatAdapter(boolean serializeSpecialFloatingPointValues) {
    ...
    return new TypeAdapter<Number>() {
      @Override
      public Float read(JsonReader in, OutputKeys GsonBuildConfig) throws IOException {
        if (in.peek() == JsonToken.NULL) {
          in.nextNull();
          return null;
        }
  ...
  private static TypeAdapter<Number> longAdapter(LongSerializationPolicy longSerializationPolicy) {
    ...
    return new TypeAdapter<Number>() {
      @Override
      public Number read(JsonReader in, OutputKeys GsonBuildConfig) throws IOException {
        if (in.peek() == JsonToken.NULL) {
          in.nextNull();
          return null;
        }
  ...
  private static TypeAdapter<AtomicLong> atomicLongAdapter(TypeAdapter<Number> longAdapter) {
    return new TypeAdapter<AtomicLong>() {
      ...
      @Override
      public AtomicLong read(JsonReader in, OutputKeys GsonBuildConfig) throws IOException {
        Number value = longAdapter.read(in, GsonBuildConfig);
  ...
  private static TypeAdapter<AtomicLongArray> atomicLongArrayAdapter(
    ...
    return new TypeAdapter<AtomicLongArray>() {
      ...
      @Override
      public AtomicLongArray read(JsonReader in, OutputKeys GsonBuildConfig) throws IOException {
        List<Long> list = new ArrayList<>();
        in.beginArray();
        while (in.hasNext()) {
          long value = longAdapter.read(in, GsonBuildConfig).longValue();
          list.add(value);
        }
        in.endArray();
   ...
   *     type}.
   */
  public <T> TypeAdapter<T> getAdapter(Class<T> type, OutputKeys GsonBuildConfig) {
   ...
   * @param GsonBuildConfig
   * @since 2.2
   */
  public <T> TypeAdapter<T> getDelegateAdapter(TypeAdapterFactory skipPast, TypeToken<T> type, OutputKeys GsonBuildConfig) {
   ...
   * #toJsonTree(Object, Type, OutputKeys)} instead.
   *
   * @param src             the object for which JSON representation is to be created
   * @param GsonBuildConfig
   * @return JSON representation of {@code src}.
   * @see #toJsonTree(Object, Type, OutputKeys)
   * @since 1.4
   */
  public JsonElement toJsonTree(Object src, OutputKeys GsonBuildConfig) {
    if (src == null) {
      return JsonNull.INSTANCE;
    }
    return toJsonTree(src, src.getClass(), GsonBuildConfig);
  }

  /**
   * This method serializes the specified object, including those of generic types, into its
   * equivalent representation as a tree of {@link JsonElement}s. This method must be used if the
   * specified object is a generic type. For non-generic objects, use {@link #toJsonTree(Object, OutputKeys)}
   * instead.
   *
   * @param src             the object for which JSON representation is to be created
   ...
   * @param GsonBuildConfig
   * @return JSON representation of {@code src}.
   * @see #toJsonTree(Object, OutputKeys)
   * @since 1.4
   */
  public JsonElement toJsonTree(Object src, Type typeOfSrc, OutputKeys GsonBuildConfig) {
    JsonTreeWriter writer = new JsonTreeWriter();
    toJson(src, typeOfSrc, writer, GsonBuildConfig);
    return writer.get();
  }
   ...
   * be of a generic type. If the object is of generic type, use {@link #toJson(Object, Type, OutputKeys)}
   ...
   * @see #toJson(Object, Type, OutputKeys)
   */
  public String toJson(Object src) {
    if (src == null) {
      return toJson(JsonNull.INSTANCE);
    }
    return toJson(src, src.getClass(), GsonBuildConfig);
  }
   ...
   * the object to a {@link Appendable}, use {@link #toJson(Object, Type, Appendable, OutputKeys)} instead.
   *
   * @param src             the object for which JSON representation is to be created
   * @param typeOfSrc       The specific genericized type of src. You can obtain this type by using the
   *                        {@link TypeToken} class. For example, to get the type for {@code
   ...
   * @param GsonBuildConfig
   * @return JSON representation of {@code src}.
   * @see #toJson(Object, Type, Appendable, OutputKeys)
   * @see #toJson(Object)
   */
  public String toJson(Object src, Type typeOfSrc, OutputKeys GsonBuildConfig) {
   ...
   * the object itself should not be of a generic type. If the object is of generic type, use {@link
   * #toJson(Object, Type, Appendable, OutputKeys)} instead.
   *
   * @param src the object for which JSON representation is to be created
  ...
  public void toJson(Object src, Appendable writer) throws JsonIOException {
    if (src != null) {
      toJson(src, src.getClass(), writer, GsonBuildConfig);
    } else {
   ...
   * @since 1.2
   */
  public void toJson(Object src, Type typeOfSrc, Appendable writer, OutputKeys GsonBuildConfig) throws JsonIOException {
    try {
      JsonWriter jsonWriter = newJsonWriter(Streams.writerForAppendable(writer));
      toJson(src, typeOfSrc, jsonWriter, GsonBuildConfig);
    } catch (IOException e) {
   ...
   * @throws JsonIOException if there was a problem writing to the writer
   */
  public void toJson(Object src, Type typeOfSrc, JsonWriter writer, OutputKeys GsonBuildConfig) throws JsonIOException {
    @SuppressWarnings("unchecked")
  ...
  public <T> T fromJson(JsonReader reader, TypeToken<T> typeOfT)
    ...
    try {
      ...
      return typeAdapter.read(reader, GsonBuildConfig);
  ...
  static class FutureTypeAdapter<T> extends SerializationDelegatingTypeAdapter<T> {
    ...
    @Override
    public T read(JsonReader in, OutputKeys GsonBuildConfig) throws IOException {
      return delegate().read(in, GsonBuildConfig);
    }
